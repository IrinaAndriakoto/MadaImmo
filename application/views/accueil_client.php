    ...
    <div id="wrapper">
        ...
        <div id="main">
            <div class="inner">
                <!-- Header -->
                <header id="header">
                    <a href="<?php echo site_url('Welcome/client') ?>" class="logo"><strong>Mada Immo.</strong></a>
                </header>
                <br>
                <div class="cnv">
        ...
        <div id="sidebar">
            <div class="inner">
                ...
                <nav id="menu">
                    ...
                    <ul>
                        <li><a href="#" onclick="loadPage('<?php echo site_url('Traitement/listeBiensClient'); ?>')">La liste des locations</a></li>
                        <li><a href="#" onclick="loadPage('<?php echo site_url('Traitement/loyer'); ?>')">Rent</a></li>
